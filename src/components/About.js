    ...
    <section id="about" className="py-24 bg-gradient-to-b from-custom-black to-custom-black/90 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="text-center mt-16" data-aos="fade-up">
          <a 
            href="#contact" 
            className="bg-custom-silver text-custom-black px-8 py-4 rounded-lg shadow-lg hover:bg-white hover:shadow-xl transition-all duration-300 inline-flex items-center font-medium"
          >
